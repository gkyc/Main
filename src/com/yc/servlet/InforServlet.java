...
public class InforServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String sql = "UPDATE `scores`.`users` SET `user_name` = '"+name+"', `user_key` = '"+password+"',`subject` = '"+subject+"', `user_pro` = '"+pro+"', `mark` = "+mark+", `mail` = '"+mail+"', `phone` = '"+phone+"', `ideal_sch1` = '"+ideal_sch1+"', `ideal_sch2` = '"+ideal_sch2+"', `ideal_sch3` = '"+ideal_sch3+"', `ideal_pro1` = '"+ideal_pro1+"', `ideal_pro2` = '"+ideal_pro2+"', `ideal_pro3` = '"+ideal_pro3+"', `major1` = '"+major1+"', `major2` = '"+major2+"', `major3` = '"+major3+"' WHERE `user_id` = '"+id+"'";
